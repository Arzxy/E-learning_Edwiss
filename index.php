...
<body>
	<div class="login-content" style="overflow: hidden; position: relative;">
        <img class="d-lg-block" style="display: none; background-size: cover; position: fixed; z-index: -3; top: 0; right: 0; width: 100%; max-height: 761px;" src="assets/image/background-pei.jpg" alt="EDWISS">
        <div class="main row">
			...
			<div class="col-12 col-lg-6" style="background-color: white; padding-top: 30px;">
            ...
            <div class="col-12 col-lg-6" style="overflow: hidden; display: flex; align-items: center;">
